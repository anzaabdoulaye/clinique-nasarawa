...
class TarifPrestationFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $tarifs = [
            ...
            ['libelle' => 'Serum glucose 250 ML', 'categorie' => CategorieTarif::CONSOMMABLE, 'prix' => 1500, 'prixPriseEnCharge' => 1500, 'medicament_nom' => 'Glucose 250ml'],
            ['libelle' => 'Serum glucose 500 ML', 'categorie' => CategorieTarif::CONSOMMABLE, 'prix' => 2000, 'prixPriseEnCharge' => 2000, 'medicament_nom' => 'Glucose 500ml'],
